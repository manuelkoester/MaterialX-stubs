...
def createValueFromStrings(*args, **kwargs) -> typing.Any:
    ...
    """
def flattenFilenames(doc: MaterialX.PyMaterialXCore.Document, searchPath: MaterialX.PyMaterialXFormat.FileSearchPath = ..., customResolver: MaterialX.PyMaterialXCore.StringResolver = None) -> None:
    pass
...
def getShaderNodes(materialNode: MaterialX.PyMaterialXCore.Node, nodeType: str = 'surfaceshader', target: str = '') -> typing.Set[MaterialX.PyMaterialXCore.Node]:
    pass
def getSubdirectories(arg0: typing.List[MaterialX.PyMaterialXFormat.FilePath], arg1: MaterialX.PyMaterialXFormat.FileSearchPath, arg2: typing.List[MaterialX.PyMaterialXFormat.FilePath]) -> None:
    pass
...
def isValidName(arg0: str) -> bool:
    pass
def loadDocuments(rootPath: MaterialX.PyMaterialXFormat.FilePath, searchPath: MaterialX.PyMaterialXFormat.FileSearchPath, skipFiles: typing.Set[str], includeFiles: typing.Set[str], documents: typing.List[MaterialX.PyMaterialXCore.Document], documentsPaths: typing.List[str], readOptions: MaterialX.PyMaterialXFormat.XmlReadOptions = None, errors: typing.List[str] = None) -> None:
    pass
def loadLibraries(libraryFolders: typing.List[MaterialX.PyMaterialXFormat.FilePath], searchPath: MaterialX.PyMaterialXFormat.FileSearchPath, doc: MaterialX.PyMaterialXCore.Document, excludeFiles: typing.Set[str] = set(), readOptions: MaterialX.PyMaterialXFormat.XmlReadOptions = None) -> typing.Set[str]:
    pass
def loadLibrary(file: MaterialX.PyMaterialXFormat.FilePath, doc: MaterialX.PyMaterialXCore.Document, searchPath: MaterialX.PyMaterialXFormat.FileSearchPath = ..., readOptions: MaterialX.PyMaterialXFormat.XmlReadOptions = None) -> None:
    pass
def parentNamePath(arg0: str) -> str:
    pass
def prependXInclude(arg0: MaterialX.PyMaterialXCore.Document, arg1: MaterialX.PyMaterialXFormat.FilePath) -> None:
    pass
def prettyPrint(arg0: MaterialX.PyMaterialXCore.Element) -> str:
    pass
def readFile(arg0: MaterialX.PyMaterialXFormat.FilePath) -> str:
    pass
def readFromXmlFileBase(doc: MaterialX.PyMaterialXCore.Document, filename: MaterialX.PyMaterialXFormat.FilePath, searchPath: MaterialX.PyMaterialXFormat.FileSearchPath = ..., readOptions: MaterialX.PyMaterialXFormat.XmlReadOptions = None) -> None:
    pass
def readFromXmlString(doc: MaterialX.PyMaterialXCore.Document, str: str, readOptions: MaterialX.PyMaterialXFormat.XmlReadOptions = None) -> None:
    pass
...
def targetStringsMatch(arg0: str, arg1: str) -> bool:
    pass
def writeToXmlFile(doc: MaterialX.PyMaterialXCore.Document, filename: MaterialX.PyMaterialXFormat.FilePath, writeOptions: MaterialX.PyMaterialXFormat.XmlWriteOptions = None) -> None:
    pass
def writeToXmlString(doc: MaterialX.PyMaterialXCore.Document, writeOptions: MaterialX.PyMaterialXFormat.XmlWriteOptions = None) -> str:
    pass
ARRAY_PREFERRED_SEPARATOR = ', '
ARRAY_VALID_SEPARATORS = ', '
